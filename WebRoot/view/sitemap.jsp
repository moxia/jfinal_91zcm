...
<title>网站地图 - Java日志(www.javalog.cn)</title>
...
<h2 style="text-align: center; margin-top: 20px">Java日志-网站地图 </h2>
<center></center>
<div id="nav"><a href="${ctx }/" title="Java日志" target="_blank"><strong>Java日志</strong></a>  » <a href="${ctx }/sitemap.html" title="Java日志网站地图">站点地图</a></div>
<div id="content">
...
<div id="bottom"><a href="${ctx }/" title="Java日志" target="_blank"><strong>Java日志</strong></a>  » <a href="${ctx }/sitemap.html" title="Java日志网站地图">站点地图</a></div>
</body>
</html>