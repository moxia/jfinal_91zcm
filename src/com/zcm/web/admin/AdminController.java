...
public class AdminController extends Controller {
	...
	public void upload() {
		...
		String filePath = ReadPropertity.getProperty("actorpictmp");
		UploadFile uploadFile = this.getFile("imgFile", filePath);
		File sFile = uploadFile.getFile();
		String newFileName = fileTime + "."+ StringUtils.getExtensionName(sFile.getName());
		File dFile = new File(sFile.getParent()+File.separator+newFileName);
	...
	public void cut() {
		...
		String filePath = PathKit.getWebRootPath()+File.separator+"upload"+ File.separator+
				ReadPropertity.getProperty("actorpictmp") + File.separator + fileName;
		try {
			OperateImage o = new OperateImage(x, y, width, height);
			o.setSrcpath(filePath);
			String newFilePath = PathKit.getWebRootPath()+File.separator+"upload"+ File.separator + fileName;
